...
exports.signupValidator = async (req, res, next) => {
    ...
    */
    ...
    if (username === "") {
        ...
        allErrors.push({ usernameError: "Username must be greater than 3 characters!" });
    }
    else if(username.length > 30){
        allErrors.push({ usernameError: "Username should not exceeds 30 characters!" });
    }
    //Contain only lowercase, numbers, underscore
    else if(!/^[a-z0-9_]+$/.test(username)){
        allErrors.push({ usernameError: "Only lowercase letters, numbers and underscore allowed!" });
    }
    ...
    if(password === ""){
        ...
        allErrors.push({ passwordError: "Password must be greater than 3 characters!" });
    }
    else if(password.length > 100){
        allErrors.push({ passwordError: "Password should not exceeds 100 characters!" });
    }
    ...
    if(confirmPassword === ""){
        ...
        allErrors.push({ confirmPasswordError: "Password and Confirm Password must be same!" });
    }
    ...
    if (allErrors.length > 0) {
        ...
        res.status(400).json({message: "Error in Signup Form Validation", allErrors: allErrors });
    }
